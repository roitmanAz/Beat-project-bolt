...
export function Header() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 transition-all duration-400" style={scrolled ? { background: "rgba(240,245,251,0.94)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(0,200,232,0.18)", boxShadow: "0 4px 24px rgba(5,15,31,0.07)" } : {}}>
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <button className="relative w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-105" style={{ background: "#fff", border: "1px solid rgba(0,200,232,0.2)", boxShadow: "0 1px 6px rgba(5,15,31,0.06)" }}>
            <ShoppingBag size={18} style={{ color: "#2a4060" }} />
            {cartCount > 0 && (
          ...
          <button className="lg:hidden w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "#fff", border: "1px solid rgba(0,200,232,0.2)" }} onClick={() => setMenuOpen(!menuOpen)}>
      ...
      {menuOpen && (
        <div className="lg:hidden border-t" style={{ background: "rgba(240,245,251,0.98)", backdropFilter: "blur(20px)", borderColor: "rgba(0,200,232,0.15)" }}>
